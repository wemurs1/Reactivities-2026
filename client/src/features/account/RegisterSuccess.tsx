...
export default function RegisterSuccess({ email }: Props) {
    ...
    return (
        <Paper sx={{
            ...
            <Typography gutterBottom variant='h3'>You have sucessfully registered</Typography>
            <Typography gutterBottom variant='h3'>Please check you email to confirm your account</Typography>
