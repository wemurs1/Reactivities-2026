...
export default function LoginForm() {
    ...
    const handleResendEmail = async () => {
        try {
            ...
            console.log(error);
            toast.error('Problem sending email - plaease check email address');
    ...
    return (
        ...
        >
            ...
            <Button onClick={loginWithGithub} startIcon={<GitHub />} sx={{ backgroundColor: 'black' }} variant='contained' size='large'>
                Login with Github
            </Button>
